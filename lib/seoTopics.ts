...
export const baseSeoTopics = [
  ...
  { label: "Fresno County youth basketball", href: "/about" },
  { label: "8U-16U basketball", href: "/teams" },
...
const pageSeoTopics: Record<string, SeoTopic[]> = {
  ...
  "/about": [
    ...
    { label: "Fresno County AAU basketball", href: "/about" },
  ],
  "/training": [
  ...
  "/teams": [
    ...
    { label: "boys basketball program", href: "/teams" },
    { label: "13U basketball", href: "/teams" },
    { label: "8U-16U basketball development", href: "/teams" },
    { label: "14U basketball", href: "/teams" },
    { label: "15U basketball", href: "/teams" },
