...
const recaps = [
  {
    title: vegasLiveS1Championship.title,
    result: `${vegasLiveS1Championship.year} ${vegasLiveS1Championship.result}`,
    matchup: "15U Dodgers Division",
    highlight: vegasLiveS1Championship.summary,
    image: vegasLiveS1Championship.image,
          ...
          <div className="overflow-hidden rounded-lg border border-[var(--line)] bg-[#071827] p-3 shadow-[0_24px_68px_rgba(7,24,39,0.16)]">
            <div className="grid gap-3 sm:grid-cols-[0.7fr_1.3fr]">
              <a
                ...
                data-analytics-label="Tournaments Vegas Live S1 championship post"
              ...
              <div className="grid content-between gap-4 p-3 text-white">
                <div>
                  ...
                  <h3 className="mt-2 font-display text-5xl leading-none">Vegas Live S1 Champions</h3>
                  <p className="mt-3 text-sm leading-6 text-white/68">
                    The 15U Huskies brought home the Dodgers Division title from
                    MADE Hoops Vegas Live Session 1.
                  </p>
                </div>
                <div className="grid grid-cols-2 gap-2 text-sm font-black">
                  {["15U", "Dodgers Division", "Las Vegas", "Champions"].map((item) => (
                ...
                <article key={recap.title} className="overflow-hidden rounded-lg bg-[#071827] text-white shadow-[0_18px_42px_rgba(7,24,39,0.12)]">
                  {recap.url ? (
                    <a
                      ...
                      rel="noopener noreferrer"
                      data-analytics-event="click_instagram"
                      data-analytics-label={`Tournament recap ${recap.title}`}
                      aria-label={`View ${recap.title} on Instagram`}
